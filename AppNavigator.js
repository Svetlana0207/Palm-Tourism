...
import CheckoutCompletedScreen from './screens/CheckoutCompletedScreen';
...
import ListImageCardsScreen from './screens/ListImageCardsScreen';
import PaymentinfoScreen from './screens/PaymentinfoScreen';
import PlaceDetailsScreen from './screens/PlaceDetailsScreen';
import ProfileScreen from './screens/ProfileScreen';
import SelectFlightScreen from './screens/SelectFlightScreen';
  ...
  return (
    <NavigationContainer linking={LinkingConfiguration}>
      <Stack.Navigator headerMode="none" initialRouteName="BottomTabNavigator">
        ...
        />
        <Stack.Screen
          name="ListImageCardsScreen"
          component={ListImageCardsScreen}
          options={{ title: 'List - Image Cards' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
